...
- Поле “Email”:
    ...
    3. Выдаёт предупреждение на ввод некорректных символов
...
- Поле “Email”:
    ...
    2. Выдаёт предупреждение на ввод некорректных символов
(поле email требует строку формата mail@mail.ru).
	1. При вводе незарегистрированной почты выводится сообщение, что пользователь не найден.
- Поле “Пароль”:
    1. Поле “Пароль” выдаёт предупреждение при вводе менее 8-ми символов..
    2. Нельзя вводить пустое поле.
    3. BUG: При вводе некорректного пароля выводится сообщение “Пользователь не найден” вместо сообщения о неправильном пароле.
...
- Поле “Поиск”:
    ...
    3. Верхняя граница длины строки отсутствует.
...
- Кнопка “Уведомления”:
    ...
    3. При нажатии вне списка уведомлений, список пропадает.
- Кнопка “Аватар”:
...
- Поля паролей:
    1. Поле “Пароль” выдаёт предупреждение при вводе менее 8-ми символов.
    2. Нельзя вводить пустое поле.
    3. BUG: Ввод пробела показывает точку, но за символ не считается.
